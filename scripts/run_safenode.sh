...
echo "SKIP_AUTO_PORT_FORWARDING : $SKIP_AUTO_PORT_FORWARDING"
echo "IDLE_TIMEOUT_MSEC : $IDLE_TIMEOUT_MSEC"
echo "KEEP_ALIVE_INTERVAL_MSEC : $KEEP_ALIVE_INTERVAL_MSEC"
echo "CON_IP : $CON_IP"
